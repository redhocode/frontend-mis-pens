      ...
      <div className="flex flex-col justify-center min-h-screen mx-auto container items-center">
        <Card>
          <CardHeader className="dark:bg-zinc-800">
            <CardTitle className="text-3xl font-semibold uppercase justify-center flex dark:bg-zinc-800 text-stone-400">
          ...
          <CardContent className="dark:bg-zinc-800">
            <CardDescription>
              <div className="flex flex-warp max-w-4xl gap-4 md:flex-col text-stone-400">
                <div className="mt-2">
              ...
              <p className="text-justify max-w-4xl mt-3">
                ...
                Politeknik Elektronika Negeri Surabaya, Kota Surabaya Memenuhi
                Syarat Peringkat “AKREDITASI UNGGUL” Sertifikat Akreditasi
                Program Studi ini berlaku sejak tanggal 22 Maret 2024 sampai
                dengan 22 Maret 2029
              </p>
              {/* Visi Misi */}
              <div className="flex flex-warp max-w-4xl gap-4 md:flex-col">
                <div className="mt-2 gap-2">
                  <p className="text-justify ">
                    ...
                    <a
                      href="https://pjj.pens.ac.id/wp-content/uploads/2019/08/Surat_Sertifikat_LAMINFOKOM_PJJ_TI.pdf"
                      target="_blank"
                ...
                <div className="mt-2 gap-2">
                  <p className="text-justify ">
                    ...
                    Perguruan Tinggi) Sertifikat Akreditasi BAN-PT untuk Prodi
                    D4 PJJ Teknik Telekomunikasi dapat di unduh :
                    <a
                      href="https://pjj.pens.ac.id/wp-content/uploads/2019/08/Akreditasi-D4-PJJ-Teknik-Telekomunikasi-PENS-2019-2024.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Akrerditasi LAM INFOKOM D3 PJJ TEKNIK INFORMATIKA
                  ...
                  <div className="mt-2">
                    <img
                      src="https://pjj.pens.ac.id/wp-content/uploads/2019/08/Sertifikat-Akreditasi-D4-PJJ-Teknik-Telekomunikasi-PENS_2-768x543.png"
                      alt=""
                      sizes=""
                    />
                  </div>
              ...
              <div className="flex flex-warp max-w-4xl gap-4 md:flex-col">
                ...
                <div className="mt-2 justify-center mx-auto">
                  ...
                  <p className="text-justify mt-4 mb-4">
                    ...
                    Studi Teknik Informatika Program Diploma Tiga pada
                    Politeknik Elektronika Negeri Surabaya di Surabaya, bersama
                    ini kami sampaikan Salinan Keputusan Menteri Riset,
                    Teknologi dan Pendidikan Tinggi untuk digunakan sebagaimana
                    mestinya
                  </p>
                </div>
              </div>
              <embed
                src="https://pjj.pens.ac.id/wp-content/uploads/2021/07/2017-SK-Prodi-D3-TI-PJJ.pdf"
                width="100%"
                height=""
                className="max-w-4xl mb-5 h-[900px] md:h-[300px]"
              />
            </CardDescription>
          </CardContent>
        </Card>
